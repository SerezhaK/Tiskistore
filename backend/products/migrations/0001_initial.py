    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.TextField(max_length=300, verbose_name='Название товара')),
                ('description', models.TextField(max_length=300, verbose_name='Описание товара')),
                ('date_joined', models.DateTimeField(default=django.utils.timezone.now, help_text='date of joined in format dd.mm.yyyy', verbose_name='Дата добавления')),
                ('last_modified_date', models.DateTimeField(default=django.utils.timezone.now, help_text='date of last changes in format dd.mm.yyyy', verbose_name='Дата последнего изменения')),
                ('price', models.FloatField(verbose_name='Цена товара')),
                ('quantity', models.FloatField(verbose_name='Колличество товара')),
                ('product_image', models.ImageField(upload_to='covers/', verbose_name='Фото')),
                ('categories', models.ManyToManyField(blank=True, to='products.category', verbose_name='Категория')),
